<template>
  <div class="bg-white">
    ...
    <div class="main mt40 p20">
      <h3 class="mb10">Q1: 怎么获得积分？</h3>
      <p class="mb10">
      在线支付的订单将获得订单积分奖励：
      </p>
      <ul class="mb10 c6">
      ...
      <h3  class="mb10">Q2: 积分用来做什么？</h3>
      <p  class="mb10">
        可以在积分商城兑换各种礼品
      </p>
      <h3  class="mb10">Q3: 礼品兑换很多天了还没有收到，该怎么办？</h3>
      <p  class="mb10">
        礼品从兑换日起，3个工作日（周末不算）内处理发货，发货后，通常会在3个工作日左右送达。
      </p>
      <h3  class="mb10">Q4: 礼品兑换中的手机充值卡兑换，怎么样进行充值，充值之前会和我电话确认嘛？</h3>
      <p  class="mb10">
